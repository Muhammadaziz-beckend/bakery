...
import "../../static/css/components/main/navigation.css";

// Лого и название организации берутся из localStorage — их туда кладёт
// Login.jsx сразу после входа (GET /auth/me/ один раз при логине), а не
// отдельным запросом на каждый рендер шапки. При отсутствии данных
// (например, старая сессия без сохранённой организации) — статичная
// заглушка /logo.png, чтобы шапка не была пустой.
export function Navigation() {
  const { organization } = Config();
  const [isOpen, setIsOpen] = useState(false);

  // На мобильной раскладке пункты меню превращаются в выпадающую панель —
  // закрываем её по клику на любую ссылку внутри, чтобы не оставалась
  // открытой поверх контента после перехода на другую страницу.
  const closeIfLink = (e) => {
  ...
  return (
    <>
      <div className={`navigation${isOpen ? " nav_open" : ""}`}>
        <div className="container_navigate">
          <div className="navigation_items">
            <div className="navigation_header">
              <div className="navigation_logo">
                <img src={organization?.logo || "/logo.png"} alt="" />
              </div>

              <div className="navigation_organization_name">
                {organization?.name || "Пекарня хаидар"}
              </div>
            ...
            <div className="navigation_links" onClick={closeIfLink}>
            <div className="navigation_main">
              ...
              <NavLink to={"/debt/"}>
                <svg
                  ...
                  width="24px"
                >
                  <path d="M240-320q17 0 28.5-11.5T280-360q0-17-11.5-28.5T240-400q-17 0-28.5 11.5T200-360q0 17 11.5 28.5T240-320Zm0-160q17 0 28.5-11.5T280-520q0-17-11.5-28.5T240-560q-17 0-28.5 11.5T200-520q0 17 11.5 28.5T240-480Zm0-160q17 0 28.5-11.5T280-680q0-17-11.5-28.5T240-720q-17 0-28.5 11.5T200-680q0 17 11.5 28.5T240-640Zm160 320h360v-80H400v80Zm0-160h360v-80H400v80Zm0-160h360v-80H400v80ZM160-120q-33 0-56.5-23.5T80-200v-560q0-33 23.5-56.5T160-840h640q33 0 56.5 23.5T880-760v560q0 33-23.5 56.5T800-120H160Zm0-80h640v-560H160v560Zm0-560v560-560Z" />
                </svg>
                Долги
              </NavLink>
            </div>
